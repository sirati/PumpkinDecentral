...
pub fn default_dispatcher(
    ...
    hide::register(&mut dispatcher, registry);
    lobby::register(&mut dispatcher, registry);
    ...
    invsee::register(&mut dispatcher, registry);
    ...
    syncstats::register(&mut dispatcher, registry);
